import { ZoozNodesStatusEditor } from '@node-states/editor';
import type { Config, HomeAssistant } from '@node-states/types';
...
describe('ZoozNodesStatus', () => {
  describe('editor.ts', () => {
    let card: ZoozNodesStatusEditor;
    ...
    beforeEach(async () => {
      ...
      card = new ZoozNodesStatusEditor();
    ...
    describe('initialization', () => {
      it('should be defined', () => {
        expect(card).to.be.instanceOf(ZoozNodesStatusEditor);
      });
