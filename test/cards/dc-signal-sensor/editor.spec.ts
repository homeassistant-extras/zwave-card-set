...
import { DcSignalSensorCardEditor } from '@z55/editor';
...
describe('DcSignalSensorCard', () => {
  describe('editor.ts', () => {
    let card: DcSignalSensorCardEditor;
    ...
    beforeEach(async () => {
      ...
      card = new DcSignalSensorCardEditor();
    ...
    describe('initialization', () => {
      it('should be defined', () => {
        expect(card).to.be.instanceOf(DcSignalSensorCardEditor);
      });
